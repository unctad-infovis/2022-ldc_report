  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: 'assets/data/WorldMap_Territories_54030.topojson', to: '../public/assets/data/WorldMap_Territories_54030.topojson', noErrorOnMissing: true, globOptions: { dot: true, gitignore: true, ignore: ['**/.DS_Store'] }},
