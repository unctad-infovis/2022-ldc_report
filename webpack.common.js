  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: 'assets/data/WorldMap_Territories_54030.topojson', to: '../public/assets/data/2022-ldc_report_world_map.topojson', noErrorOnMissing: true, globOptions: { dot: true, gitignore: true, ignore: ['**/.DS_Store'] }},
